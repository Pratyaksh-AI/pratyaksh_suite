...
import { Download, ArrowRight, Globe, Smartphone, Lock, ShieldCheck } from 'lucide-react';
import { THEME } from '../data/constants';
import AccessGuard from '../components/AccessGuard';

export const DownloadScreen = ({ setPage }) => (
  // AccessGuard listens to: artifacts/{appId}/public/data/user_access/{uid}
  // This matches the Rust Admin's write path exactly.
    ...
    <div className={`min-h-screen ${THEME.bg} pt-32 px-6`}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-100 text-green-800 text-xs font-bold uppercase tracking-widest mb-6 border border-green-200">
              <ShieldCheck size={14} /> License Active
            </div>
          ...
          <div className="bg-[#111111] p-12 flex flex-col justify-between text-white">
            <div>
              <h4 className="text-lg font-medium mb-6">Installation Key</h4>
              <div className="bg-[#222] p-4 rounded font-mono text-[#4FF978] text-sm break-all mb-8 border border-white/10 flex items-center gap-2">
                <Lock size={14} /> PK-ENT-2026-X9Y2-8842-SECURE
              </div>
            ...
            <div className="bg-[#4FF978] p-6 mt-12 text-black">
              ...
              <p className="text-sm opacity-80 mb-4">Direct line to engineering support.</p>
              <span className="underline font-bold cursor-pointer hover:opacity-80" onClick={() => setPage('contact')}>Contact Support</span>
            </div>
          </div>
        </div>
      </div>
